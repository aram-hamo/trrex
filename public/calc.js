  ...
  switch(gameType){
    case "queens":
      ...
      document.getElementById("game").innerHTML +=`
        <tr id=`+gameType+` >
          <td>Queens</td>
          <td><input onchange="updateRecords();updateUI();" id="`+"0-"+round+"-"+gameType+`" type=number min=0 max=4></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"1-"+round+"-"+gameType+`" type=number min=0 max=4></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"2-"+round+"-"+gameType+`" type=number min=0 max=4></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"3-"+round+"-"+gameType+`" type=number min=0 max=4></td>
        </tr>`;
      gamesCounter++;
    ...
    case "letoosh": 
      ...
      document.getElementById("game").innerHTML +=`
        <tr id=`+gameType+` >
          <td>Letoosh</td>
          <td><input onchange="updateRecords();updateUI();" id="`+"0-"+round+"-"+gameType+`" type=number min=0 max=13></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"1-"+round+"-"+gameType+`" type=number min=0 max=13></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"2-"+round+"-"+gameType+`" type=number min=0 max=13></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"3-"+round+"-"+gameType+`" type=number min=0 max=13></td>
        </tr>`;
      gamesCounter++;
    ...
    case "king": 
      ...
      document.getElementById("game").innerHTML +=`
        <tr id=`+gameType+` >
          <td>king</td>
          <td><input onchange="updateRecords();updateUI();" id="`+"0-"+round+"-"+gameType+`" type=number min=0 max=1></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"1-"+round+"-"+gameType+`" type=number min=0 max=1></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"2-"+round+"-"+gameType+`" type=number min=0 max=1></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"3-"+round+"-"+gameType+`" type=number min=0 max=1></td>
        </tr>`;
      gamesCounter++;
    ...
    case "trex": 
      ...
      document.getElementById("game").innerHTML +=`
        <tr id=`+gameType+` >
          <td>Trex</td>
          <td><input onchange="updateRecords();updateUI();" id="`+"0-"+round+"-"+gameType+`" step="50" type=number min=0 max=200></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"1-"+round+"-"+gameType+`" step="50" type=number min=0 max=200></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"2-"+round+"-"+gameType+`" step="50" type=number min=0 max=200></td>
          <td><input onchange="updateRecords();updateUI();" id="`+"3-"+round+"-"+gameType+`" step="50" type=number min=0 max=200></td>
        </tr>`;
      gamesCounter++;
